    ...
    return (
      <main className="pilot-portal">
        ...
        <section aria-labelledby="portal-title">
          ...
          <aside><h2>About this release</h2><p>Your accounting workspace opens on this same website. The new standalone accounting platform remains in development and is not available for financial transactions.</p><p>Use evaluation data during the pilot. Real company records require an approved onboarding and data-protection plan.</p></aside>
        </section>
